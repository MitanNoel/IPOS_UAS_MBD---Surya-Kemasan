...
<head>
    ...
    <title>Tambah Supplier | Sistem Toko</title>
        ...
        <div class="max-w-3xl mx-auto">
            <div class="flex items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p class="text-gray-500 mt-1">Masukkan data supplier baru untuk kebutuhan pembelian.</p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                    <h2 class="font-semibold text-gray-800">Form Supplier</h2>
                </div>
                <form action="process_insert.php" method="POST" class="p-6 grid grid-cols-1 gap-5">
                    <div>
                        ...
                        <input id="nama_supplier" name="nama_supplier" type="text" required class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none" placeholder="Nama perusahaan / toko">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2" for="no_telp">No. Telepon</label>
                        <input id="no_telp" name="no_telp" type="text" required class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none" placeholder="Contoh: 08123456789">
                    </div>
